...
public class QuestRepositoryFake implements QuestRepository {
    ...
    private QuestLevelMapDto getLevelThree() {
        ...
        dto.setQuest(quest);
        dto.setLevelId(3);
        dto.setName("Level 3 - A mi la guardia!");

        List<List<Integer>> map = new ArrayList<>();

        String mapRaw = "7,8,8,8,8,8,8,8,8,8,8,8,9;11,82,31,32,22,23,24,25,26,0,71,72,98;1,2,2,2,2,2,2,2,2,2,2,2,3";
        ...
        dto.setChapterInfo("<div class='p-2 text-lg font-italic text-justify'>" //
                + "        Entras en una habitación aparentemente tranquila. Tres criaturas cuelgan del techo con mirada amenazante y, aunque permanecen inmóviles, sabes que atacarán cuando estés cerca.<br/>Al fondo, una puerta da acceso a la habitación contigua." //
                + "    </div>" //
                + "    <div class='info-tip'>" //
                + "        <b>TIP</b>: Usa tu habilidad <span class='info-tag'>lookAt()</span> de la clase <span class='info-tag'>Warrior</span> para saber si estás cerca de un enemigo y puedes atacarle." //
                + "    </div>" //
                + "    <h2 class='mt-4'>Habilidades</h2>" //
                + "    <div class='mt-2'>" //
                + "        <h3>Acciones (solo una por turno)</h3>" //
                + "        <div>" //
                + "            <div><span class='info-tag'>warrior.walk(direction? : Direction)</span></div>" //
                + "            <div class='ml-3 mt-2'>" //
                + "                Avanza una posición en el mapa. La dirección de avance (<span class='info-tag'>Direction.Right</span><span> o </span><span class='info-tag'>Direction.Left</span><span>) es opcional y por defecto será </span><span class='info-tag'>Direction.Right</span>." //
                + "            </div>" //
                + "        </div>" //
                + "        <div class='mt-4'>" //
                + "            <div><span class='info-tag'>warrior.lookAt(direction? : Direction) : TileType</span></div>" //
                + "            <div class='ml-3 mt-2'>" //
                + "                Observa lo que hay en una posición del mapa adyacente. La dirección a observar (<span class='info-tag'>Direction.Right</span><span> o </span><span class='info-tag'>Direction.Left</span><span>) es opcional y por defecto será </span><span class='info-tag'>Direction.Right</span>." //
                + "            </div>" //
                + "        </div>" //
                + "    </div>" //
                + "    <div class='mt-6'>" //
                + "        <h3>Sentidos</h3>" //
                + "        <div>" //
                + "            <div><span class='info-tag'>warrior.think(message : string)</span></div>" //
                + "            <div class='ml-3 mt-2'>" //
    ...
    private QuestLevelMapDto getLevelTwo() {
        ...
        dto.setChapterInfo("<div class='p-2 text-lg font-italic text-justify'>" //
                + "        Entras en una habitación aparentemente tranquila. Tres criaturas cuelgan del techo con mirada amenazante y, aunque permanecen inmóviles, sabes que te atacarán en cuanto estés cerca.<br/>Al fondo, una puerta da acceso a la habitación contigua." //
                + "    </div>" //
                + "    <div class='info-tip'>" //
                + "        <b>TIP</b>: Usa tu habilidad <span class='info-tag'>lookAt()</span> de la clase <span class='info-tag'>Warrior</span> para saber si estás cerca de un enemigo y puedes atacarle." //
                + "    </div>" //
    ...
    private QuestLevelMapDto getLevelOne() {
        ...
        dto.setChapterInfo("<div class='p-2 text-lg font-italic text-justify'>" //
                ...
                + "    </div>" //
                + "    <div class='info-tip'>" //
                + "        <b>TIP</b>: Intenta avanzar hacia delante dentro del método <span class='info-tag'>play()</span> de la clase <span class='info-tag'>Warrior</span>." //
                + "    </div>" //
                + "    <h2 class='mt-4'>Habilidades</h2>" //
                + "    <div class='mt-2'>" //
                + "        <h3>Acciones (solo una por turno)</h3>" //
